/*
 * This file automatically produced by /usr/local/Wolfram/Mathematica/10.0/SystemFiles/Links/MathLink/DeveloperKit/Linux-x86-64/CompilerAdditions/mprep from:
 *	./addtwo.tm
...
#endif
{
	int _res;
	_res = MLConnect(mlp);
	if (_res) _res = _definepattern(mlp, (char *)"AddTwo[i_Integer, j_Integer]", (char *)"{ i, j }", 0);
